                        ...
                        <div class="main-content pb-2">
                            <div class="row py-4">
                                ...
                                <div class="info col-lg-6">
                                    Mọi ý kiến đóng góp xin vui lòng điền vào Form dưới đây và gửi cho chúng tôi. Xin chân thành cảm ơn!
                                    <form action="">
                                        <table class="w-100">
                                            <tr>
                                                <td>Họ tên</td>
                                                <td>
                                                    <div class="input-group">
                                                        <span class="input-group-text"><i class='fas fa-address-book pe-1'></i></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <span class="input-group-text"><i class='fas fa-mobile-alt px-1'></i></span>
                                                        <input type="text" class="form-control">
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="reset" class="bg-secondary"><b>NHẬP LẠI</b></button>
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
                                ...
                                <div class="des col-lg-6 ps-4 align-content-center row bg-light">
                                    <div class="">
                                        ...
                                        <p class="text-center">Địa chỉ: Đường Phú Minh, Văn Trì, Minh Khai, Bắc Từ Liêm Hà Nội.</p>
